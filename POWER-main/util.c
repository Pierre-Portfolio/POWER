...
realloc : refaire malloc ==> agrandit le malloc/tableau*/
{
    ...
    return tableau; //impossible de retourner taille_tableau aussi ==> modifier manuellement lors de l'appel
}
...
}//impossible de retourner taille_tableau ==> modifier manuellement lors de l'appel
