...
void affiche_plateau(S_plateau p1)
{
    ...
    printf("\n\t  %c",186);color(15,2);printf("        ");color(15,0);printf("%c   %c        %c        %c        %c   %c        %c   %c        %c        %c        %c   %c",186,179,179,179,179,186,186,179,179,179,179,186);color(15,1);printf("   08   ");color(15,0);printf("%c",186);
...
void affiche_plateau2(S_plateau p1)
{
    printf("DANS Plateau.c : %d \n",p1.plateaux[8][0].terrain);
...
void print_case5 (){
    ...
    for(int i=0;i<9;i++){
        ...
        printf("\n");
        for(j=start;j<9;j++){
            print_case2(p1.plateaux[i][j],i,j);
        }
        printf("\n");
        for(j=start;j<9;j++){
            print_case3(p1.plateaux[i][j]);
        }
        printf("\n");
        for(j=start;j<9;j++){
            print_case4(p1.plateaux[i][j]);
        }
        printf("\n");
        for(j=0;j<9;j++){
            print_case5();
